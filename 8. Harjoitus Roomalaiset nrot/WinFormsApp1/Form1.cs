...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void MuutaBT_Click(object sender, EventArgs e)
        {
            ...
            string vastaus = "";
            if (LukuTB.Text.Length > 3) // Neljä lukua
            {
            ...
            {
                luku2 = Convert.ToInt32(LukuTB.Text.Substring(0, 1));
                luku3 = Convert.ToInt32(LukuTB.Text.Substring(1, 1));
                luku4 = Convert.ToInt32(LukuTB.Text.Substring(2, 1));
                vastaus += sataset(luku2, vastaus);
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
                VastausLB.Text = vastaus;
            ...
            {
                luku3 = Convert.ToInt32(VastausLB.Text.Substring(0, 1));
                luku4 = Convert.ToInt32(VastausLB.Text.Substring(1, 1));
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
                VastausLB.Text = vastaus;
                VastausLB.Visible = true;
            ...
            {
                luku4 = Convert.ToInt32(VastausLB.Text.Substring(0, 1));
                vastaus += ykkoset(luku4, vastaus);
                VastausLB.Text = vastaus;
                VastausLB.Visible = true;
            }
