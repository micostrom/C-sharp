...
namespace _18._Harjoitus_Oppilaitos
{
    public partial class AvainhenkilotFrom : Form
    {
        DataTable oppilaitos = new DataTable();
        DataTable vastuuHenkilot = new DataTable();
        DataTable yhteys = new DataTable();
        public AvainhenkilotFrom()
        {
            InitializeComponent();
        }
        ...
        private void AvainhenkilotFrom_Load(object sender, EventArgs e)
        {
